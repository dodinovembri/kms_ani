                    ...
                    <div class="card-body">
                        <form method="POST" action="<?php echo base_url('user/update/');
                            ...
                            <div class="mb-3 form-group row">
                                ...
                                <div class="col-sm-10">
                                    <img height="150" width="150" src="<?php echo base_url('uploads/user/');
                                                                        echo $user->image ?>" alt="">
                            ...
                            <div class="mb-3 form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="password" name="password" class="form-control" placeholder="Enter password" id="pass">
                                </div>
                            ...
                            <div class="mb-3 form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="password" name="password_confirm" class="form-control" placeholder="Enter password confirm" id="pass2">
                                </div>
                                <div class="col-sm-1" style="margin-top: 12px;">
