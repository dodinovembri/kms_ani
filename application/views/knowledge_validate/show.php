            ...
            <div class="container-xl px-4">
                ...
                <?php if ($tacit_knowledge->status == 0) { ?>
                    <div class="text-center mt-5">
                        ...
                        <div class="mb-3">
                            <a href="<?php echo base_url('knowledge_validate/accept_by_admin/'); echo $tacit_knowledge->id; ?>"><button class="btn btn-primary mx-2 px-3" role="button">
                                <i class="me-2" data-feather="thumbs-up"></i>
                                Yes
                            </button></a>
                            <a href="<?php echo base_url('knowledge_validate/reject_by_admin/'); echo $tacit_knowledge->id; ?>"><button class="btn btn-danger mx-2 px-3" role="button">
