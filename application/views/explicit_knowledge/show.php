                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="mb-3 form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="category" value="<?php echo $explicit_knowledge->category ?>">
                                </div>
                            </div>
                            <div class="mb-3 form-group row">
                            ...
                            <div class="mb-3 form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="description" rows="7" class="form-control" required><?php echo $explicit_knowledge->category ?></textarea>
                                </div>
                            </div>
                            <div class="mb-3 form-group row">
