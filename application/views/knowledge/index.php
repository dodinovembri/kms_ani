                                ...
                                foreach ($knowledges as $key => $value) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="
                                                    <?php if ($value->is_tacit == 1) {
                                                        echo base_url('tacit_knowledge/edit/');
                                                        echo $value->id;
                                                    } else {
                                                        echo base_url('explicit_knowledge/edit/');
                                                        echo $value->id;
                                                    } ?>
                                                "><button class="btn btn-datatable btn-icon btn-transparent-dark"><i data-feather="edit"></i></button></a>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a href="
                                                    <?php if ($value->is_tacit == 1) {
                                                        echo base_url('tacit_knowledge/destroy/');
                                                        echo $value->id;
                                                    } else {
                                                        echo base_url('explicit_knowledge/destroy/');
                                                        echo $value->id;
                                                    } ?>
                                                ">
                                                   <button class="btn btn-danger" type="button">Delete Data</button></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
